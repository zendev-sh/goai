---
title: Quick Start
description: "Get started with GoAI in minutes. Generate and stream text with OpenAI, Anthropic, Google, and 22+ LLM providers using a unified Go API."
---
...
All 22+ providers work the same way:
